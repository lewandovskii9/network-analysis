...
| 03 | [Cridex/Dridex, Remcos Infection](./wireshark/dridex-remcos-withLaterMovement-infection/writeup.md) |  → Malicious HTTP download → PE file execution → C2 communication | Dridex  |
---
