...
| 03 | [Cridex/Dridex, Remcos RAT Infection](./wireshark/dridex-remcos-withLaterMovement-infection/writeup.md) | Multi-stage PE download (MSXMLHTTP) → Remcos RAT C2 → Dridex post-exploitation | Dridex  |
---
