...
| 21:49      | TCP SYN, connection to malware server         | 172.17.8.109 → 91.121.30.169        |
| 21:49      | HTTP GET /91msE95B/actiV.bin                  | 172.17.8.109 → 91.121.30.169        |
| 21:49      | DirecPLL.DLL received, PE (MZ)                | 91.121.30.169 → 172.17.8.109        |
| 21:49      | IDS: PE EXE download + Shellcode detected     | 91.121.30.169 → 172.17.8.109        |
| 21:52      | Dridex C2 beacon, TLS handshake               | 172.17.8.109 → 192.241.220.183      |
| 21:52      | IDs alert: Dridex SSL certificate detected    | 192.241.220.183 → 172.17.8.109      |
| 21:55      | Dridex C2 beacon,  second server              | 172.17.8.109 → 216.239.94.252       |
